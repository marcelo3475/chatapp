                ...
                <h2>Login page</h2>
                  ...
                  <form>
                    ...
                    <fieldset>
                      ...
                      { !user ? (<button onclick={signOut} className="sign-out" type="button">Sign Out</button>) && <Welcome/> : (<button className='sign-in'>
                      <img onclick={googleSignIn} src={GoogleSignin}  alt='sign in with google' type="button" /></button>) && <ChatBox/>}
